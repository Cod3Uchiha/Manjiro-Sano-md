...
france(
    ...
    const text = arg.join(" ")
     ...
     let baseURI = "/apps/" + s.HEROKU_APP_NAME;
        ...
        await repondre('*_HEROKU VAR UPDATE HO GAYI HAI AB Manjiro-Sano-md RESTART HO RAHA HAI...'_*)
    }
);
...
let str = '*🔰 Manjiro-Sano-md HEROKU VARS 🔰*\n\n'
for (vr in h) {
str+= '🦋 *'+vr+'* '+'= '+h[vr]+'\n'
}
 repondre(str)
